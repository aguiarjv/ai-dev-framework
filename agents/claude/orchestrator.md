...
database. Obtain user approval before creating integration or task worktrees or
starting implementation.

After approval, use worktree-management to create the plan integration
worktree from the approved baseline, then create a separate task worktree and
